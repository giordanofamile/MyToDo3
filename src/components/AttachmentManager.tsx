...
import { FileText, Loader2, Download, Trash2, UploadCloud, Image as ImageIcon } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-[10px] text-gray-400 font-medium mt-1">Plusieurs fichiers acceptés</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {attachments.map((att) => {
          ...
          const hasError = imageErrors[att.id];
