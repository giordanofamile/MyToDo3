...
const GanttView = ({ tasks, onTaskClick }: GanttViewProps) => {
  ...
  return (
    <div className="bg-white/50 dark:bg-white/5 backdrop-blur-2xl rounded-[3rem] border border-white/50 dark:border-white/10 overflow-hidden flex flex-col h-[600px] shadow-2xl">
      {/* Header des dates */}
