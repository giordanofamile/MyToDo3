  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        {[
          ...
          <motion.div 
            ...
            className="bg-white dark:bg-white/5 p-6 rounded-xl shadow-xl border border-gray-100 dark:border-white/10 relative overflow-hidden group"
          >
            <div className={cn("w-12 h-12 rounded-lg flex items-center justify-center mb-4 transition-transform group-hover:scale-110", `bg-${card.color}-500/10`)}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-white/5 p-8 rounded-xl shadow-2xl border border-gray-100 dark:border-white/10">
